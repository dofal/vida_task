...
const Results = (props) => {
  ...
  return (
    <div className='flex flex-col gap-8'>
        ...
        <button className="flex gap-2 hover:translate-y-1 hover:scale-105 transition ease-in-out duration-300 justify-center items-center py-3 px-1 rounded-lg text-md font-bold text-white bg-indigo-500">Restartovat kvíz<MdRestartAlt size={28} /></button>
    </div>
  )
}
